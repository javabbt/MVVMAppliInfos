...
import com.yannickloic.mvvm.utils.Constants
import com.yannickloic.mvvm.utils.Constants.Companion.SEARCH_DELAY
...
class SearchNewsFragment : Fragment (R.layout.fragment_search_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //mise en œuvre du délai de recherche
        var job: Job? = null
        etSearch.addTextChangedListener {editable->
            ...
            job= MainScope().launch {
                ...
                //après délai, verifier si editable est null,
                editable?.let {
    ...
    val scrollListener= object : RecyclerView.OnScrollListener(){
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            //calculer manuellement les numéros pour la pagination
